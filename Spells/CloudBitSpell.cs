...
namespace WiiWandz.Spells
{
    abstract class CloudBitSpell : Spell
    {
        ...
        public CloudBitSpell(String device, String authorization, String iftttKey, String iftttEvent)
		{
            setConfigurations(device, authorization, iftttKey, iftttEvent);
			this.strokesForSpell = new List<List<StrokeDirection>>();
		}

        public void setConfigurations(String device, String authorization, String iftttSecretKey, String iftttEvent)
        {
            this.device = device;
